...
public class Login2 extends AppCompatActivity {
    ...
    private AppCompatButton verifyOTPBtnL;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtOTP=findViewById(R.id.otpL);
        verifyOTPBtnL=findViewById(R.id.loginL);
        mAuth = FirebaseAuth.getInstance();
        Intent i = getIntent();
        phoneno = i.getStringExtra("PhoneNo");
        sendVerificationCode(phoneno);

        verifyOTPBtnL.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private PhoneAuthProvider.OnVerificationStateChangedCallbacks
        ...
        public void onVerificationFailed(FirebaseException e) {
            ...
            Toast.makeText(Login2.this, e.getMessage(), Toast.LENGTH_LONG).show();
        }
    };
